...
<div class="container py-4">
 ...
 class="img-fluid rounded main-img h-140 w-100" style="height: 410px;">
        </div>
        <div class="col-md-6">
            <div class="row g-2">
                <div class="col-6"><img src="https://a0.muscache.com/im/pictures/miso/Hosting-687326818861051595/original/61beb3c6-6451-4ba3-b886-fcbe76d6f571.jpeg?im_w=1200" class="image w-100" alt="Interior" style="height: 200px; object-fit: cover; border-radius: 10px;"></div>
                <div class="col-6"><img src="https://a0.muscache.com/im/pictures/miso/Hosting-687326818861051595/original/61beb3c6-6451-4ba3-b886-fcbe76d6f571.jpeg?im_w=1200" class="image w-100" alt="Bedroom" style="height: 200px; object-fit: cover; border-radius: 10px;"></div>
                <div class="col-6"><img src="https://a0.muscache.com/im/pictures/miso/Hosting-687326818861051595/original/61beb3c6-6451-4ba3-b886-fcbe76d6f571.jpeg?im_w=1200" class="image w-100" alt="Bathroom" style="height: 200px; object-fit: cover; border-radius: 10px;"></div>
                <div class="col-6"><img src="https://a0.muscache.com/im/pictures/miso/Hosting-687326818861051595/original/61beb3c6-6451-4ba3-b886-fcbe76d6f571.jpeg?im_w=1200" class="image w-100" alt="View" style="height: 200px; object-fit: cover; border-radius: 10px;"></div>
            </div>
            <button class="btn btn-light position-absolute bottom-0 end-0 me-3 mb-3 d-flex align-items-center gap-2 shadow-sm" style="border-radius: 8px; font-size: 14px; font-weight: 600;">
                    ...
                    <p class="text-center text-secondary small mb-4">You won't be charged yet</p>
                        ...
                        <div class="mb-0">
                            <div class="d-flex justify-content-between mb-2">
                                <div class="text-decoration-underline"> रु85 x 5 nights</div>
                                <div> रु425</div>
                            </div>
                            <div class="d-flex justify-content-between mb-2">
