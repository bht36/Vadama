    ...
    <div class="col-md-6 d-flex align-items-center justify-content-center">
      <div class="card p-4 shadow-lg login-form" style="width: 100%; max-width: 450px;">
        <div class="text-center">
          <h4 class="mt-2 fw-semibold text-dark fs-3">Sign up as a Seller</h4>
        </div>
        <form action="{{ route('seller_info_store') }}" method="POST">
          @csrf
...
<style>
  * {
  ...
  .image-section {
    background: url('https://source.unsplash.com/800x800/?house,rental') no-repeat center center;
