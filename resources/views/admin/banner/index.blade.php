                                ...
                                <div class="collapse" id="collapseExample">
                                    <div class="card card-body">
                                        ...
                                        <div class="card-body p-0">
                                            <form action="{{ route('admin.banner.index') }}" method="GET" id="filterForm">
                                        ...
                                        <tbody>
                                            @forelse ($banner as $key => $data)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <img src="{{ asset('storage/uploads/banner/main_image/' . $data->main_image) }}" alt="Insignia" style="width: 500px; height: 300px;">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <form method="POST" action="{{ route('admin.banner.delete', $data->id) }}">
                                                                @csrf
                                                                @method('DELETE')
