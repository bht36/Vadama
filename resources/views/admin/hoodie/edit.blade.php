        ...
        <div class="content-header px-3">
            <div class="container-fluid">
                <div class="row mb-2 mx-1">
                    <div class="col-sm-6">
                        <h1 class="m-0">{{ __(' Edit Stories') }}</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="mr-2">
                                <a title="Go Back" href="{{ route('admin.blog.index') }}"
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('admin.blog.index') }}">{{ __('Stories') }}</a>
                            </li>
                            <li class="breadcrumb-item">
                                {{ __('Edit Stories') }}
                            </li>
                            ...
                            <form method="POST" enctype="multipart/form-data"
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 form-group-translation col-md-4">
                                        ...
                                        <input id="name" type="text" name="name"
                                            value="{{ old('name', $blog->name) }}" placeholder="Title" class="form-control @error('name')
                                                is-invalid
                                            @enderror">
                                    ...
                                    <div class="mb-3 form-group-translation col-md-4">
                                        ...
                                        <input id="slug" type="text" name="slug"
                                            value="{{ old('slug', $blog->slug) }}" placeholder="Slug" class="form-control @error('slug')
                                                is-invalid
                                            @enderror">
                                    ...
                                    <div class="mb-3 form-group-translation col-md-4">
                                        <label for="sub_title" class="form-label">Sub-title <span
                                                class="text-danger">*</span></label>
                                        <input id="sub_title" type="text" name="sub_title" value="{{ old('sub_title', $blog->sub_title) }}"
                                ...
                                <div class="mb-3 form-group-translation col-md-6">
                                        ...
                                        <select id="category_id" name="category_id" class="form-control @error('category_id') is-invalid @enderror">
                                            ...
                                            <option value="{{ $categories->id }}" {{ old('category_id', $blog->category_id) == $categories->id ? 'selected' : '' }}>
                                            {{ $categories->title }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row">
                                    <div class="mb-3 form-group-translation col-md-12">
                                        <label for="blog Title" class="form-label">HTML Title<span class="text-danger"> *</span></label>
                                        <input id="html_title" type="text" name="html_title"
                                            value="{{ old('html_title', $blog->html_title) }}" placeholder="HTML Title"
                                    ...
                                    <div class="mb-3 form-group-translation col-md-12">
                                        ...
                                        <textarea name="meta_description" id="" cols="8" rows="3" placeholder="Meta Description"
                                            class="form-control @error('meta_description')
                                                is-invalid
                                            @enderror">{{ old('meta_description', $blog->meta_description) }}</textarea>
                                ...
                                <div class="row">
                                    <div class="mb-3 form-group-translation col-md-12">
                                        ...
                                        <textarea name="meta_keyword" cols="8" rows="3" placeholder="Meta Keyword"
                                                  class="form-control @error('meta_keyword') is-invalid @enderror">
                                            {{ old('meta_keyword', $blog->meta_keyword) }}
                                        </textarea>
                                ...
                                <div class="row">
                                    <div class="mb-3 form-group-translation col-md-6">
                                        ...
                                        <select id="type_div1" name="media_type" class="form-control @error('media_type')
                                            ...
                                            <option id="youtube1" data-youtube="youtube" value="youtube1"
                                                @if ($blog->youtube_link != null) selected @endif>Youtube</option>
                                            <option value="image1" data-image="image"
                                                @if ($blog->main_image != null) selected @endif>Image</option>
                                        </select>
                                        @if ($errors->has('type'))
                                    ...
                                    <div class="mb-3 form-group-translation col-md-6" id="media-input-container">
                                        <div id="showyoutube1" class="myDiv1 youtube_div1">
                                            ...
                                            <input id="youtube_link" type="text" name="youtube_link"
                                                ...
                                                placeholder="Youtube Link" class="form-control @error('youtube_link')
                                                is-invalid
                                            @enderror">
                                        ...
                                        <div class="div myDiv1 image_div1 mb-3" id="showimage1">
                                            ...
                                            @if ($blog->main_image)
                                            <img src="{{ asset('storage/uploads/blog/' . $blog->main_image) }}" alt="Insignia" style="width: 300px; height: 150px;">
                                            @endif
                                            <br>
                                    ...
                                    <div class="mb-3 form-group-translation col-md-12 image_div1" id="showimage2">
                                        ...
                                        <img src="{{ asset('storage/uploads/blog/' . $blog->mobile_image) }}" alt="Insignia" style="width: 300px; height: 150px;">
